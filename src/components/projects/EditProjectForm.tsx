...
import { updataProject } from "@/api/projectApi";
        ...
        <div className="max-w-3xl mx-auto">
            ...
            >
                ...
                <input
                    ...
                    className=" bg-fuchsia-600 p-3 w-full uppercase font-bold text-white hover:bg-fuchsia-700 cursor-pointer transition-colors"
                />
            </form>
        </div>
    )
